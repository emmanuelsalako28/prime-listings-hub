...
export const houses: House[] = [
  {
    ...
    description: 'This exquisite 5-bedroom detached duplex offers the perfect blend of luxury and comfort. Located in the prestigious Lekki Phase 1, this property features tasteful finishing throughout, modern amenities, and a serene environment perfect for families.',
    type: 'house',
  },
  {
    id: 'house-2',
    ...
    description: 'A stunning semi-detached duplex with contemporary architecture in the heart of Ikoyi. Perfect for modern families seeking style and convenience.',
    type: 'house',
  },
  {
    id: 'house-3',
    ...
    description: 'An ultra-luxury mansion on the exclusive Banana Island. This architectural masterpiece offers unparalleled luxury living with world-class amenities.',
    type: 'house',
  },
  {
    id: 'house-4',
    ...
    description: 'A well-finished 3-bedroom bungalow in a secure estate. Ideal for small families or first-time homeowners.',
    type: 'house',
  },
];
...
export const lands: Land[] = [
  {
    ...
    description: 'A prime piece of dry land in the fast-developing Lekki Phase 2 area. Fully fenced with valid Certificate of Occupancy.',
    type: 'land',
  },
  {
    id: 'land-2',
    ...
    description: 'Rare beachfront land opportunity. Perfect for resort development or private beach house.',
    type: 'land',
  },
  {
    id: 'land-3',
    ...
    description: 'Premium commercial land in Victoria Island. Ideal for office complex or mixed-use development.',
    type: 'land',
  },
  {
    id: 'land-4',
    ...
    description: 'Affordable investment opportunity in the Lagos Free Trade Zone corridor. High appreciation potential.',
    type: 'land',
  },
];
